...
def vgg16(dataset='cifar10'):
    return VGG(dataset=dataset, cfg=defaultcfg[16])

def vgg19(dataset='cifar10'):
    return VGG(dataset=dataset, cfg=defaultcfg[19])

# model = vgg19()
# model = model.cuda()
# state = torch.load("/mnt/xiaolong/code/train_from_scratch/checkpoints/cifar10/vgg16/LTH/loss_surface/lt_imp/sp0.945/lr0.05/seed914_lr0.05_5.pt")
