...
# load_weight_path = "./checkpoints/{}/LTH/initial_weight/seed_{}.pth.tar".format(arch, seed)
load_weight_path = "./checkpoints/{}/LTH/pretraining/ep90/lr{}/cosine_bs_1024_5ep_warmup/checkpoint-5.pth.tar".format(arch, lr)
